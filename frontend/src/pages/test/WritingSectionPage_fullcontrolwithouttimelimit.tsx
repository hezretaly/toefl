...
const WritingSectionPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // In a real implementation, this would submit the writing responses
      // Example: await submitWritingResponses(section.id, responses, token);
      console.log("Submitting:", { sectionId: section.id, responses });
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4"> {/* Added gap */}
            ...
            <div className="mt-4 sm:mt-0">
              ...
              <Timer
                ...
                initialMinutes={Math.floor(currentTask.time_limit / 60)}
                initialSeconds={currentTask.time_limit % 60}
                onTimeout={() => {
