...
const mockStudents = [
  { id: 1, name: "John Doe", submittedDate: "2023-04-05", wordCount: 320 },
  { id: 2, name: "Jane Smith", submittedDate: "2023-04-06", wordCount: 425 },
  { id: 3, name: "Robert Johnson", submittedDate: "2023-04-07", wordCount: 287 }
];

const WritingSectionReviewPage = () => {
      ...
      <main className="flex-1 py-8">
        <div className="toefl-container max-w-5xl">
          <div className="flex flex-col lg:flex-row items-start justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold mb-2">Writing Test Reviews</h1>
              <p className="text-gray-600">
                Review writing test submissions and provide feedback.
              </p>
            </div>
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="text-center py-4 px-4 font-medium text-gray-600">Word Count</th>
                    ...
                    {mockStudents.map(student => (
                      <tr key={student.id} className="border-b hover:bg-gray-50">
                        ...
                        <td className="py-4 px-4 text-right">
                          <Button 
                            onClick={() => navigate(`/review/writing/${secId}/feedback/${student.id}`)}
                            variant="outline"
                            size="sm"
                          >
                            Review
